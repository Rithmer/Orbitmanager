...
| 13 | Unit-тесты проходят (`npm test`)                                | ✅ 129 тестов, 11 suite (Этапы 1–8) |
...
| 17 | Переход на PostgreSQL потребует только ~~новых репозиториев +~~ STORAGE_MODE=postgres | ✅ StorageModule + все Prisma-репозитории реализованы |
