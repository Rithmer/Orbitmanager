...
const makeContext = (): RiskPageContext => ({
  ...
  tasksByProject: new Map([
    [10, [
      { id: 1, projectId: 10, name: 'Task A', status: 'in_progress', difficulty: 4, deadline: new Date('2026-04-10'), createdAt: new Date('2026-03-01'), assigneeIds: [100] },
      { id: 2, projectId: 10, name: 'Task B', status: 'new', difficulty: 2, deadline: new Date('2026-05-01'), createdAt: new Date('2026-03-10'), assigneeIds: [101] },
    ]],
  ]),
  ...
  inputsByTaskId: new Map([
    [1, { taskId: 1, difficulty: 4, deadline: '2026-04-10T00:00:00.000Z', createdAt: '2026-03-01T00:00:00.000Z', status: TaskStatus.IN_PROGRESS, assigneeCount: 1, assigneeLoad: 2, statusChangesCount: 1, daysSinceCreation: 20, daysUntilDeadline: 10 }],
    [2, { taskId: 2, difficulty: 2, deadline: '2026-05-01T00:00:00.000Z', createdAt: '2026-03-10T00:00:00.000Z', status: TaskStatus.NEW, assigneeCount: 1, assigneeLoad: 0, statusChangesCount: 0, daysSinceCreation: 10, daysUntilDeadline: 30 }],
  ]),
  allInputs: [
    { taskId: 1, difficulty: 4, deadline: '2026-04-10T00:00:00.000Z', createdAt: '2026-03-01T00:00:00.000Z', status: TaskStatus.IN_PROGRESS, assigneeCount: 1, assigneeLoad: 2, statusChangesCount: 1, daysSinceCreation: 20, daysUntilDeadline: 10 },
    { taskId: 2, difficulty: 2, deadline: '2026-05-01T00:00:00.000Z', createdAt: '2026-03-10T00:00:00.000Z', status: TaskStatus.NEW, assigneeCount: 1, assigneeLoad: 0, statusChangesCount: 0, daysSinceCreation: 10, daysUntilDeadline: 30 },
  ],
});
