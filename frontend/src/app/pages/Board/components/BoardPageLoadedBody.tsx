...
import { BoardPageModals } from '@/app/pages/Board/components/BoardPageModals'

type ProjectBoardViewData = NonNullable<ReturnType<typeof useProjectBoardViewQuery>['data']>

type TaskPendingAction = 'status' | 'delete'

type BoardMutationsSlice = {
